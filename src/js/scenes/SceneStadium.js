...
import {TEXTURE_STADIUM as TEXTURE_STADIUM} from './../Loader';
...
export default class SceneGalaxy {
  ...
  initBackground() {
    ...
    const SPHERE_MATERIAL = new THREE.MeshBasicMaterial({
      map: TEXTURE_STADIUM.BACKGROUND,
  ...
  modelField() {
    ...
    const FIELD_MATERIAL = new THREE.MeshLambertMaterial({map: TEXTURE_STADIUM.FIELD});
